...
public class AndroidDriverPool {
    public static AndroidDriver create() {
        ...
        caps.setCapability(MobileCapabilityType.PLATFORM_NAME, "33");
        caps.setCapability(MobileCapabilityType.APP, System.getProperty("user.dir") + File.separator + "Office-Buddy.apk");
